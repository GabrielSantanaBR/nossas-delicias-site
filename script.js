(()=>{
 const css=['v6/v6-public.css?v=6','v6/v6-admin.css?v=6','v6/v6-admin-readable.css?v=7'];
 css.forEach(h=>{const l=document.createElement('link');l.rel='stylesheet';l.href=h;document.head.appendChild(l)});
 const files=['v6/v6-state.js?v=6','v6/v6-shop.js?v=6','v6/v6-account.js?v=6','v6/v6-admin-core.js?v=6','v6/v6-admin-business.js?v=6','v6/v6-admin-reports.js?v=6','v6/v6-init.js?v=6'];
